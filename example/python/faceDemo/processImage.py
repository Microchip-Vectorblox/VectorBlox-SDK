...
def main():
    ...
    parser.add_argument('--modelDet', default='../../../tutorials/pytorch/retinaface.mobilenet/retinaface.mobilenet.vnnx')
    ...
    fdc = faceDemoClass.faceDemo(args.modelDet, args.modelRec, None, createDict=False, debugImages=args.debug)
