...
if [ -f FFNet-78S-LowRes_512x288.pre.post.tflite ]; then
    ...
    vnnx_compile -c V1000 -t FFNet-78S-LowRes_512x288.pre.post.tflite -o FFNet-78S-LowRes_512x288.vnnx
fi

if [ -f FFNet-78S-LowRes_512x288.vnnx ]; then
    echo "Running Simulation..."
    python $VBX_SDK/example/python/segmentation.py FFNet-78S-LowRes_512x288.vnnx $VBX_SDK/tutorials/test_images/A0PQ76.jpg --dataset cityscapes --inj 
    echo "C Simulation Command:"
    echo '$VBX_SDK/example/sim-c/sim-run-model FFNet-78S-LowRes_512x288.vnnx $VBX_SDK/tutorials/test_images/A0PQ76.jpg  '
fi
