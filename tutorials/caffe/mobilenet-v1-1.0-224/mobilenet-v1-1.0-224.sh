...
generate_vnnx -x mobilenet-v1-1.0-224.xml  -c V1000 -f ../../sample_images -o mobilenet-v1-1.0-224.vnnx

echo "Running Simulation..."
python $VBX_SDK/example/python/imagenet.py mobilenet-v1-1.0-224.vnnx ../../oreo.224.jpg
