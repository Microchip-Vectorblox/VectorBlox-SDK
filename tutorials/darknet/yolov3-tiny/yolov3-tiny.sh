...
if [ -f yolov3-tiny.pre.tflite ]; then
    ...
    vnnx_compile -c V1000 -t yolov3-tiny.pre.tflite -o yolov3-tiny.vnnx
fi

if [ -f yolov3-tiny.vnnx ]; then
    echo "Running Simulation..."
    python $VBX_SDK/example/python/yoloInfer.py yolov3-tiny.vnnx $VBX_SDK/tutorials/test_images/dog.jpg -j yolov3-tiny.json -v 3 -l coco.names 
    echo "C Simulation Command:"
    echo '$VBX_SDK/example/sim-c/sim-run-model yolov3-tiny.vnnx $VBX_SDK/tutorials/test_images/dog.jpg YOLOV3'
fi
