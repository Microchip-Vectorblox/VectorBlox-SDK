...
python $VBX_SDK/example/python/darknet_to_onnx.py yolov2-voc.cfg

echo "Running Model Optimizer..."
# model details @ https://pjreddie.com/darknet/yolo/
converter --input_model yolov2-voc.onnx \
--framework onnx \
...
python $VBX_SDK/example/python/yoloInfer.py yolov2-voc.vnnx ../../dog.jpg -j yolov2-voc.json -l voc.names
