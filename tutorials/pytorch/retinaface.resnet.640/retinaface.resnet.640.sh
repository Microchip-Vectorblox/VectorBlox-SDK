...
echo "Downloading retinaface.resnet.640..."
...
mv FaceDetector.onnx ../retinaface.resnet.640.onnx
cd ..

echo "Running Model Optimizer..."
# model details @ https://github.com/biubug6/Pytorch_Retinaface
mo --input_model retinaface.resnet.640.onnx \
...
generate_vnnx -x retinaface.resnet.640.xml  -c V1000 -f ../../sample_images -o retinaface.resnet.640.vnnx

echo "Running Simulation..."
python $VBX_SDK/example/python/retinaface.py retinaface.resnet.640.vnnx ../../test_images/3faces.jpg
