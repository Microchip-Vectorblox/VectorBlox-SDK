...
if [ -f torchvision_resnet18.pre.tflite ]; then
    ...
    vnnx_compile -c V1000 -t torchvision_resnet18.pre.tflite -o torchvision_resnet18.vnnx
fi

if [ -f torchvision_resnet18.vnnx ]; then
    echo "Running Simulation..."
    python $VBX_SDK/example/python/classifier.py torchvision_resnet18.vnnx $VBX_SDK/tutorials/test_images/oreo.jpg 
    echo "C Simulation Command:"
    echo '$VBX_SDK/example/sim-c/sim-run-model torchvision_resnet18.vnnx $VBX_SDK/tutorials/test_images/oreo.jpg CLASSIFY'
fi
