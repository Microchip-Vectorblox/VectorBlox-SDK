...
echo "Downloading retinaface.mobilenet.320..."
...
generate_vnnx -x retinaface.mobilenet.xml  -c V1000 -f ../../sample_images -o retinaface.mobilenet.320.vnnx --bias-correction

echo "Running Simulation..."
python $VBX_SDK/example/python/retinaface.py retinaface.mobilenet.320.vnnx ../../test_images/3faces.jpg
