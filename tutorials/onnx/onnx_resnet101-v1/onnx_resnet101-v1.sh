...
wget --no-check-certificate https://media.githubusercontent.com/media/onnx/models/main/vision/classification/resnet/model/resnet101-v1-7.onnx
...
python $VBX_SDK/example/python/classifier.py onnx_resnet101-v1.vnnx ../../test_images/oreo.jpg
