...
wget https://media.githubusercontent.com/media/onnx/models/main/vision/classification/squeezenet/model/squeezenet1.1-7.onnx
...
python $VBX_SDK/example/python/classifier.py onnx_squeezenet1.1.vnnx ../../oreo.jpg
