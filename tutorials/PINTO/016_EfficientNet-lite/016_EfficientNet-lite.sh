...
if [ -f 016_EfficientNet-lite.pre.tflite ]; then
    ...
    vnnx_compile -c V1000 -t 016_EfficientNet-lite.pre.tflite -o 016_EfficientNet-lite.vnnx
fi

if [ -f 016_EfficientNet-lite.vnnx ]; then
    echo "Running Simulation..."
    python $VBX_SDK/example/python/classifier.py 016_EfficientNet-lite.vnnx $VBX_SDK/tutorials/test_images/oreo.jpg 
    echo "C Simulation Command:"
    echo '$VBX_SDK/example/sim-c/sim-run-model 016_EfficientNet-lite.vnnx $VBX_SDK/tutorials/test_images/oreo.jpg CLASSIFY'
fi
