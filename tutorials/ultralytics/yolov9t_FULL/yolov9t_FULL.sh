...
if [ -f yolov9t_FULL.pre.tflite ]; then
    ...
    vnnx_compile -c V1000 -t yolov9t_FULL.pre.tflite -o yolov9t_FULL.vnnx
fi

if [ -f yolov9t_FULL.vnnx ]; then
    echo "Running Simulation..."
    python $VBX_SDK/example/python/yoloInfer.py yolov9t_FULL.vnnx $VBX_SDK/tutorials/test_images/dog.jpg -v 8 -l coco.names 
    echo "C Simulation Command:"
    echo '$VBX_SDK/example/sim-c/sim-run-model yolov9t_FULL.vnnx $VBX_SDK/tutorials/test_images/dog.jpg ULTRALYTICS_FULL'
fi
