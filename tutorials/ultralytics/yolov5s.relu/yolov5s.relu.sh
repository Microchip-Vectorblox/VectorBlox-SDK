...
wget -q https://vector-blox-model-zoo.s3.us-west-2.amazonaws.com/Releases/ModelZoo/ultralytics.yolov5s.relu.onnx
...
if [ -f yolov5s.relu.vnnx ]; then
    ...
    echo '$VBX_SDK/example/sim-c/sim-run-model yolov5s.relu.vnnx $VBX_SDK/tutorials/test_images/dog.jpg YOLOV5'
fi
