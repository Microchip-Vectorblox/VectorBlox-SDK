...
if [ -f yolov8n.vnnx ]; then
    ...
    python $VBX_SDK/example/python/yoloInfer.py yolov8n.vnnx $VBX_SDK/tutorials/test_images/dog.jpg -v 8 -l coco.names 
    echo "C Simulation Command:"
    echo '$VBX_SDK/example/sim-c/sim-run-model yolov8n.vnnx $VBX_SDK/tutorials/test_images/dog.jpg ULTRALYTICS'
fi
