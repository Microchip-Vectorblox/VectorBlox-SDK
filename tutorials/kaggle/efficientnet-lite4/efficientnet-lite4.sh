...
if [ -f efficientnet-lite4.pre.tflite ]; then
    ...
    vnnx_compile -c V1000 -t efficientnet-lite4.pre.tflite -o efficientnet-lite4.vnnx
fi

if [ -f efficientnet-lite4.vnnx ]; then
    echo "Running Simulation..."
    python $VBX_SDK/example/python/classifier.py efficientnet-lite4.vnnx $VBX_SDK/tutorials/test_images/oreo.jpg 
    echo "C Simulation Command:"
    echo '$VBX_SDK/example/sim-c/sim-run-model efficientnet-lite4.vnnx $VBX_SDK/tutorials/test_images/oreo.jpg CLASSIFY'
fi
